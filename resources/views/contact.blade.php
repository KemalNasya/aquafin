...
@section('content')
    ...
    <section class="hero-section position-relative overflow-hidden" 
        style="min-height: 60vh; background: url('{{ asset('assets/jj.jpg') }}') center/cover no-repeat; display: flex; align-items: center;">
        
        <!-- Overlay -->
        <div class="position-absolute top-0 start-0 w-100 h-100" 
            style="background: linear-gradient(90deg, #0a2c4d 0%, #154e8d 100%); opacity: 0.85; border-bottom: 2px solid rgba(255,255,255,0.2); transition: all 0.3s ease;">
        </div>

        <div class="container position-relative text-center text-white py-5">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h1 class="fw-bold mb-3" style="font-size: 2.2rem; text-shadow: 3px 3px 6px rgba(0,0,0,0.6); animation: fadeInUp 1s ease-out;">
                        Hubungi Kami
                    </h1>
                    <p class="lead mb-4" style="font-size: 1.05rem; text-shadow: 2px 2px 4px rgba(0,0,0,0.4); animation: fadeInUp 1.5s ease-out;">
                        Kami siap membantu Anda dengan layanan budidaya ikan terbaik
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-8">
                    <div class="card border-0 shadow rounded-3 overflow-hidden">
                        <div class="card-header text-white py-3" 
                            style="background: linear-gradient(90deg, #0a2c4d 0%, #154e8d 100%);">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('contact.store') }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-primary px-4 py-2 fs-6 rounded-pill shadow" 
                                    style="background: linear-gradient(90deg, #0a2c4d 0%, #154e8d 100%); border: none; transition: all 0.3s ease;">
                    ...
                    <div class="card border-0 shadow rounded-3 overflow-hidden">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-grid gap-2">
                                <a href="https://wa.me/622112345678" class="btn btn-success rounded-pill px-4 py-2 fs-6" target="_blank">
                                    <i class="fab fa-whatsapp me-2"></i>WhatsApp
                                </a>
                                <a href="tel:+622112345678" class="btn btn-primary rounded-pill px-4 py-2 fs-6" 
                                    style="background: linear-gradient(90deg, #0a2c4d 0%, #154e8d 100%); border: none;">
    ...
    <style>
        ...
        .form-control:focus { border-color: #154e8d; box-shadow: 0 0 0 0.2rem rgba(21,78,141,0.25); }

        ...
        <div class="container position-relative text-center text-white py-5" style="z-index: 2;">
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <h1 class="display-5 fw-bold mb-3 text-shadow-dark animate-fade-in" style="animation-delay: 0.2s;">
                        Hubungi Pereng Mina GAP
                    </h1>
                    <p class="lead fs-6 mb-4 text-shadow-dark opacity-75 animate-fade-in" style="animation-delay: 0.4s;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control form-control-sm" id="email"
                                            name="email" required placeholder="Masukkan alamat email">
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="subject" name="subject"
                                        required placeholder="Subjek pesan">
                                </div>
                                <div class="mb-4">
                                    <label for="message" class="form-label fw-bold small">Pesan</label>
                                    <textarea class="form-control form-control-sm" id="message" name="message" rows="4" required
                    ...
                    <div class="card border-0 shadow rounded-3 overflow-hidden">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="d-grid gap-2">
                                <a href="https://wa.me/6281344535062"
                                    class="btn btn-success rounded-pill px-3 py-2 fs-6 hover-lift shadow-sm"
                                    target="_blank">
                                    <i class="fab fa-whatsapp me-2"></i>WhatsApp
                                </a>
                                <a href="tel:+6281344535062"
                                    class="btn btn-primary rounded-pill px-3 py-2 fs-6 hover-lift shadow-sm bg-gradient-custom-primary">
            ...
            <div class="card border-0 shadow rounded-3 overflow-hidden">
                <div class="card-body p-0">
                    <div class="map-container" style="height: 350px;">
                        <iframe 
                       src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3953.1554950457294!2d110.348354!3d-7.773331000000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zN8KwNDYnMjQuMCJTIDExMMKwMjAnNTQuMSJF!5e0!3m2!1sid!2sid!4v1761027827031!5m2!1sid!2sid"
                        width="100%" 
                        height="100%" 
                        style="border:0;" 
                        allowfullscreen="" 
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            animatedElements.forEach((el, index) => {
                ...
                el.style.animation =
                    `fadeInUp 1s ease-out forwards ${el.style.getPropertyValue('animation-delay')}`;
            });
        });
    </script>
@endpush

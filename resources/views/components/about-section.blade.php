    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6" style="animation: fadeInUp 1.2s ease-out;">
                <h2 class="fw-bold mb-4 text-primary" style="text-shadow: 1px 1px 2px rgba(0,0,0,0.1);">Sejarah Kami
                </h2>
                <p class="lead mb-4 text-dark">Didirikan sejak tahun 2010, kami telah berkembang menjadi pemimpin dalam
                    budidaya ikan berkelanjutan di Indonesia, dengan fokus pada inovasi dan pelestarian lingkungan.</p>
                <div class="about-features">
                    <div class="feature-item d-flex mb-3 p-3 rounded shadow-sm hover-lift">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Metode ramah lingkungan untuk menjaga ekosistem air dan tanah.
                            </p>
                        </div>
                    </div>
                    <div class="feature-item d-flex mb-3 p-3 rounded shadow-sm hover-lift">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">Didukung oleh petani dan ilmuwan berpengalaman dalam spesies ikan
                                lokal.</p>
                        </div>
                    </div>
                    <div class="feature-item d-flex mb-3 p-3 rounded shadow-sm hover-lift">
                ...
                <a href="/about" class="btn btn-gradient btn-lg mt-3 shadow"
                    style="animation: fadeInUp 1.5s ease-out;"><i class="fas fa-arrow-right me-2"></i>Selengkapnya</a>
            </div>
        </div>
    </div>
